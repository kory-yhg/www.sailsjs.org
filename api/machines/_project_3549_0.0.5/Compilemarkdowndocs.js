module.exports = {
  ...
  "fn": function(inputs, exits, env) {
    ...
    Filesystem.rmrf({
      dir: require('path').resolve(env.sails.config.appPath, 'views/partials/creating-a-machinepack/'),
    }).exec({
      ...
      success: function() {
        ...
        DocTemplater()
          .build([{
            remote: 'git://github.com/node-machine/docs.git',
            remoteSubPath: 'creating-a-machinepack',
            htmlDirPath: 'views/partials/creating-a-machinepack/',
            jsMenuPath: 'views/partials/docs.jsmenu',
            outputExtension: 'ejs',
